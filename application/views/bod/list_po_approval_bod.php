			...
			<div class="col-md-12 dkp-isian ">
				...
				<div class="portlet red-flamingo box full-height-content full-height-content-scrollable">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-shopping-cart"></i>List PO APPROVAL
						</div>
						<div class="tools">
...
jQuery(document).ready(function() {
	...
	$('#list_bod_approval').parent().addClass('active');
...
function initial_table()
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'bod/get_po_approval_bod/'?>';

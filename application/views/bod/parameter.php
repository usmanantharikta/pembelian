					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase"> Set Parameter PO </span>
							</div>
							<div class="actions">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3">Maximum Price Per Item </label>
												<div class="col-md-9 ">
													<input type='text' id='item' value="<?php echo $param[0]['item_max'] ;?>" name="item" class="form-control ">
													<span class="help-block old_password"></span>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-3">Maximum Total Price</label>
												<div class="col-md-9 ">
													<input type='text' id='total' value="<?php echo $param[0]['total_max'] ;?>" name="total" class="form-control ">
													<span class="help-block old_password"></span>
												</div>
											</div>
										</div>
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-offset-3 col-md-9">
                        <button type="submit" onclick="create_user()" class="btn green">Save</button>
...
$('#bod-param').addClass('active open');
...
item_max.val(numeral(item_max.val()).format(0,0));
total_max.val(numeral(total_max.val()).format(0,0));
...
Metronic.startPageLoading({animate: true});
  ...
  function create_user(){
    ...
    $('.help-block').empty(); // clear error string
       $.ajax({
           url : '<?php echo site_url('/bod/save_param') ?>',
           type: "POST",
           data: formdata,
           processData: false,
           contentType: false,

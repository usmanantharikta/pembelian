              ...
              <form id="form-bjum" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-body">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          ...
                          <span class="help-block">
											...
											<div class="form-group">
												<label class="control-label col-md-3">Divisi/Bagian</label>
												<div class="col-md-9">
                    ...
                    <div class="col-md-6 ">
											<div class="form-group">
												<label class="control-label col-md-3">Jumlah BUM</label>
												<div class="col-md-9">
											...
											<div class="form-group">
												<label class="control-label col-md-3">Jumlah PJUM</label>
												<div class="col-md-9">
											...
											<div class="form-group">
												<label class="control-label col-md-3">Kelebihan / Kekurangan </label>
												<div class="col-md-9">
									...
									<div class="row">
										<div class="col-md-6 ">
											...
											<div class="form-group">
												<label class="control-label col-md-3">Date Invoice</label>
												<div class="col-md-9">
										...
										<div class="col-md-6 ">
											<div class="form-group">
												<label class="control-label col-md-3">BPB NO</label>
												<div class="col-md-9">
													<input name="bpb_no" type="text" class="form-control" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>

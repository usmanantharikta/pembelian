...
jQuery(document).ready(function() {
	...
	$('#list_bjum_approved').parent().addClass('active');
...
function initial_table()
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'keuangan/get_list_pjum_acked'?>';
...
function ack_pjum(id_bum){
	bootbox.confirm({
		message: "Are you sure want Acknowledge this PJUM ?",
		buttons: {
				confirm: {
						label: 'Yes',
		...
		callback: function (result) {
				if(result){
					Metronic.startPageLoading({animate: true});
					var url='<?php echo site_url().'/keuangan/ack_pjum/'?>'+id_bum;

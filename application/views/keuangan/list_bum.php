...
function initial_table()
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'keuangan/get_bum_need_ack'?>';
...
function ack_bum(id_bum){
	bootbox.confirm({
		message: "Are you sure want Acknowledge this BUM ?",
		buttons: {
				confirm: {
						label: 'Yes',
		...
		callback: function (result) {
				if(result){
					Metronic.startPageLoading({animate: true});
					var url='<?php echo site_url().'/keuangan/ack_bum/'?>'+id_bum;

...
<head>
<meta charset="utf-8"/>
<title>List Progress Payment</title>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<span>List progress Payment</span>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			...
			<div class="col-md-12 dkp-isian ">
				...
				<div class="portlet red-flamingo box full-height-content full-height-content-scrollable">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-shopping-cart"></i>List progress Payment
						</div>
						<div class="tools">
...
jQuery(document).ready(function() {
	...
	$('#list_pp').parent().addClass('active');
...
function initial_table()
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'bum/get_list_pp/'?>';

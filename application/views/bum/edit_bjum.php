...
<?php $this->load->view('include/slidebar');?>
			...
			<div class="row">
              ...
              <form id="form-bjum" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group hide">
                      <label class="control-label col-md-3">ID BJUM</label>
                      <div class="col-md-9">
                        <input value="<?php echo $id_bjum ?>" name="id_bjum" type="text" class="form-control" placeholder="PO No">
                        <span class="help-block">
                        </span>
                      </div>
                    </div>
									...
									<div class="row">
										<div class="col-md-6 ">
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="invoice_no" value="" type="text" class="form-control" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="invoice_date" value="" type="text" class="form-control datepicker" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
										...
										<div class="col-md-6 ">
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="fp_no" value="" type="text" class="form-control" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="fp_date" value="" type="text" class="form-control datepicker" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
										...
										<div class="col-md-6 ">
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="sj_no" type="text" value="" class="form-control" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="sj_date" type="text" value="" class="form-control datepicker" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          ...
                          <span class="help-block">
										...
										<div class="col-md-6 ">
											<div class="form-group">
												<label class="control-label col-md-3">Doc Lain</label>
												<div class="col-md-9">
                      ...
                      <tbody>
                        ...
                        for ($i=0; $i < count($files) ; $i++) {
                          foreach ($files[$i] as $key => $value) {
                            ...
                            echo '<td> <button type="button" class="btn" onclick="delete_item('.$folder.','.$file.')" btn-danger">Delete</button> </td> </tr>';
                          }
                        }
                      }
                        ?>
              ...
              <!-- END FORM-->
						...
						<div class="modal-footer">
							...
							<button id="submit-first" type="button" onclick="update_bjum_master()" class="btn green">Save</button>
						</div>
					</div>
	...
	jQuery(document).ready(function() {
	 ...
	 "drawCallback": function( settings ) {
	   ...
	   $('[name="jumlah_bum"]').val(numeral(jumlah_bum).format(0,0));
	...
	function update_total()
	{
			...
			$('[name="total"]').val(numeral(tot_bjum+(tot_bjum*10/100)).format(0,0));
	...
	function update_bjum_master()
	{
		...
		$.ajax({
				url : '<?php echo site_url().'bum/update_bjum'?>',
				type: "POST",
				// data: {'id_item': id,'colom':colom, 'table': table},
				data: formd,
				processData: false,
	...
	function delete_item(folder, file){
		var id_bjum=$('[name="id_bjum"]').val();
		$.ajax({
				url : '<?php echo site_url().'/bum/delete_bjum'?>',
				type: "POST",
				data: {'id': id_bjum,'folder':folder, 'file': file},
				// data: fo,
				// processData: false,
				// contentType: false,
				dataType: "JSON",

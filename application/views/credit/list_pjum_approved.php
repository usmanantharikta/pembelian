...
<head>
<meta charset="utf-8"/>
<title>List TTBP Approved</title>
			...
			<div class="col-md-12 dkp-isian ">
				...
				<div class="portlet red-flamingo box full-height-content full-height-content-scrollable">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-shopping-cart"></i>List TTBP APPROVED
						</div>
						<div class="tools">
...
jQuery(document).ready(function() {
	...
	//active slide bar
	$('#credit').addClass('active open');
	$('#list_credit_approved').parent().addClass('active');
...
function initial_table()
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'pjum/get_list_pjum_credit_approved'?>';

Project Management System | Module Pembelian <br><!DOCTYPE html>
<!--
			...
			<div class="col-md-12 dkp-isian ">
				...
				<div class="portlet red-flamingo box full-height-content full-height-content-scrollable">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-shopping-cart"></i>List Credit
						</div>
						<div class="tools">
...
jQuery(document).ready(function() {
	...
	$('#list_credit').parent().addClass('active');
...
function initial_table()
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'bum/get_list_credit/'?>';

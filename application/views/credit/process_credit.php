									...
									<div class="row">
										<div class="col-md-6 hide">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="type_top" type="text" value="credit" class="form-control" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
										...
										<div class="col-md-6 ">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input name="invoice_value" type="text" class="form-control" placeholder="">
													<span class="help-block">
													 </span>
												</div>
											</div>
				...
				if(data.status)
				{
					...
					// alert('success');
						bootbox.alert({
							...
							message: 'Well Done !!!!',
							callback: function(){
								var url='<?php echo site_url().'pjum/process_credit/'.$id_po.'/'.$id_top.'/'?>'+data.id_pjum;
								window.location=url;
								// location.reload();
							}
						});

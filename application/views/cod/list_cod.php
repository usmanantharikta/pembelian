					...
					<div class="portlet-body" >
						...
						<form id="form_cod" method="post" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="modal-footer">
								...
								<button type="button" onclick="build_cod()" class="btn green">Create</button>
							</div>
				</form>
				<!-- button -->
				</div>
...
function initial_table()
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'bum/get_list_cod/'?>';

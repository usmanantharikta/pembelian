			...
			<div class="col-md-12 dkp-isian ">
				...
				<div class="portlet red-flamingo box full-height-content full-height-content-scrollable">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-shopping-cart"></i>List PO Draf
						</div>
						<div class="tools">
...
var $table='';
	...
	$('#po_draf').parent().addClass('active');
...
$("#form-filter").submit(function(event){
	...
	$.ajax({
		url: "<?php echo site_url('po/get_po_draf'); ?>",
		type: 'POST',
		data: formData,
		dataType: "JSON",
		async: false,

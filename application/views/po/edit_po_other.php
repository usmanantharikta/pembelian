							...
							<form id="form_po_det" method="post" enctype="multipart/form-data" class="form-horizontal">
									<div class="form-body">
										<div class="table-responsive">
											<button type="button" name="button" onclick="add_row()" class="btn btn-success"><i class="fa fa-plus"></i> Add Item</button>
											<table class="table table-striped table-bordered table-hover" id="table_material">
											 <thead>
														<tr>
															...
															<!-- <th> Kode Barang </th> -->
															<!-- <th> Nama Barang</th> -->
															<th> Nama Bahan <span class="required" aria-required="true"> * </span> </th>
															<th> Merek </th>
															<!-- <th> SPPr NO</th> -->
								...
								<!-- /span -->
										...
										<div class="col-md-6 ">
											...
											<div class="form-group hide">
												...
												<div class="col-md-9">
													<input data-option="<?php echo site_url().'po/get_detail_master/'?>" value="<?php echo $id_po ?>" name="id_po" type="text" class="form-control" placeholder="PO No">
													<span class="help-block">
													</span>
												</div>
											</div>
...
function update_total()
{
		...
		$('[name="ppn"]').val(numeral(tot_ppn).format(0,0));
		$('[name="pph"]').val(numeral(tot_pph).format(0,0));
		$('[name="total_bt"]').val(numeral(total).format(0,0));
		$('[name="total"]').val(numeral(tot_ppn+total+tot_pph).format(0,0));
		$('[name="nominal"]').val(numeral(tot_ppn+total+tot_pph).format(0,0));
...
function get_list_po()
{
	...
	var url='<?php echo site_url().'po/get_po_edit_other/'?>'+id_po;
	...
	$.ajax({
			...
			success: function(data)
			{
				for (var i = 0; i < data.isi.length; i++) {
					 var string_td='<tr>';
					 string_td+='<td><input type="hidden" value="'+data.isi[i].po_master_id+'" name="id_po"> <input type="hidden" value="'+data.isi[i].id_po_detail+'"name="id_po_detail[]"> <input type="text" value="'+data.isi[i].nama_pasar+'" name="'+data.isi[i].id_po_detail+'_nama_pasar"></td>\
										 <td> <input type="text" value="'+data.isi[i].merek+'"name="'+data.isi[i].id_po_detail+'_merek"></td>\
										 <td> <input type="text" class="qty_po" value="'+data.isi[i].qty_po+'" name="'+data.isi[i].id_po_detail+'_qty_po"></td>\
										 <td> <input type="text" value="'+data.isi[i].stn_po+'"name="'+data.isi[i].id_po_detail+'_stn_po"></td>\
										 <td> <input type="text" class="hgs" value="'+data.isi[i].hgs+'" name="'+data.isi[i].id_po_detail+'_hgs"></td>\
										 <td> <input type="text" class="disc" value="'+data.isi[i].disc+'" name="'+data.isi[i].id_po_detail+'_disc"></td>\
										 <td> <input type="text" class="jumlah" value="'+data.isi[i].jumlah+'" name="'+data.isi[i].id_po_detail+'_jumlah"></td>\
										 <td> <input type="text" class="ppn" value="'+data.isi[i].ppn+'" name="'+data.isi[i].id_po_detail+'_ppn"></td>\
										 <td> <input type="text" class="pph" value="'+data.isi[i].pph+'" name="'+data.isi[i].id_po_detail+'_pph"></td>\
										 <td> '+data.isi[i].last_hgs+' </td>\
										 <td> <a class="btn btn-danger btn-delete" onclick="delete_po_other('+data.isi[i].id_po_detail+')"><i class="fa fa-trash"></i></a></td>\
											</tr>';

										 $('#tbody-item').append(string_td);
										 // var table=$('#table_material').DataTable({
										 // 	"bDestroy": true,
										 // 	 "dom": 'rt'
								 // });
...
function sumbit_po()
{
	...
	$.ajax({
			...
			error: function (jqXHR, textStatus, errorThrown)
			{
			 ...
			 function delete_po_other(id){
				 $.ajax({
						 url : '<?php echo site_url().'po/delete_po_other/'?>'+id, // calculate ID BUM
						 // data:
						 type: "POST",
						 dataType: "JSON",
						 success: function(data)
			 ...
			 {
			 	var string_td='<tr>';
			 	string_td+='<td><input type="hidden" value="'+count+'"name="id_po_detail[]"><input type="text" name="'+count+'_nama_pasar"></td>\
			 						<td> <input type="text" name="'+count+'_merek"></td>\
			 						<td> <input type="text" class="qty_po" value=0 name="'+count+'_qty_po"></td>\
			 						<td> <input type="text" name="'+count+'_stn_po"></td>\
			 					 	<td> <input type="text" class="hgs" value=0 name="'+count+'_hgs"></td>\
			 						<td> <input type="text" class="disc" value=0 name="'+count+'_disc"></td>\
			 						<td> <input type="text" class="jumlah" value=0 name="'+count+'_jumlah"></td>\
			 						<td> <input type="text" class="ppn" value=0 name="'+count+'_ppn"></td>\
			 						<td> <input type="text" class="pph" value=0 name="'+count+'_pph"></td>\
			 						<td> 0 </td>\
			 						<td> <a class="btn btn-danger btn-delete"><i class="fa fa-trash"></i></a></td>\
			  					 </tr>';

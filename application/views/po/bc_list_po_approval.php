					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase"> List PO APPROVAL  </span>
							</div>
							<div class="actions">
...
var $table='';
	...
	$('#list_po_approval').parent().addClass('active');
  ...
  console.log('level bod: '+level_bod);
	//dataTables
...
$("#form-filter").submit(function(event){
	...
	$.ajax({
		url: "<?php echo site_url('po/get_po_approval'); ?>",
		type: 'POST',
		data: formData,
		dataType: "JSON",
		async: false,
  ...
  if(id_po_master==0){
	...
	bootbox.confirm({
		...
		callback: function (result) {
				if(result){
					Metronic.startPageLoading({animate: true});
					var url='<?php echo site_url().'/po/approve_po/'?>'+id_po_master;
					$.ajax({
							url : url,
							type: "POST",
